...
// LocationPreset 签到位置预设（地址库）
type LocationPreset struct {
	ID          uint      `gorm:"primaryKey" json:"id"`
	UserUID     int64     `gorm:"not null;default:0;index" json:"user_uid"` // 0 = 全局预设，>0 = 用户私有
	Name        string    `gorm:"size:255;not null" json:"name"`
	Latitude    string    `gorm:"size:64;not null" json:"lat"`
	Longitude   string    `gorm:"size:64;not null" json:"lng"`
